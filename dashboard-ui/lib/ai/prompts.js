...
exports.PROMPTS = exports.PROSPERO_PICO_PROMPT = exports.EXTRACTION_PROMPT = exports.SCREENING_PROMPT = void 0;
exports.renderPrompt = renderPrompt;
// =====================================================
// SCREENING PROMPT
// =====================================================
exports.SCREENING_PROMPT = {
    version: '1.0',
    model_requirements: [
...
function renderPrompt(template, data) {
    ...
    // Handle {{#each}} loops
    rendered = rendered.replace(/\{\{#each ([^}]+)\}\}([\s\S]*?)\{\{\/each\}\}/g, (match, arrayKey, content) => {
...
// =====================================================
exports.PROMPTS = {
    SCREENING: exports.SCREENING_PROMPT,
    EXTRACTION: exports.EXTRACTION_PROMPT,
    PROSPERO_PICO: exports.PROSPERO_PICO_PROMPT
};
